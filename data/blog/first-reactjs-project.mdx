...
tags: ['React']
draft: false
summary: 'This article covers NPM and NPX and a Basic command to initialize your app.'
---
...
Instead of only installing a bunch of dependencies and that's it, npx is an abbreviation of npm, and it will initialize your React app with all the folder and basic setup you need to run a complete React app (without needing you to create the setup folders). It's like a starter kit or even _similar_ as those commands that create a skeleton of your Express app (if you come from a backend background).
